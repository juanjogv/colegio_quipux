...
public class TeacherEntity {
    ...
    @JoinColumn(name = "teacher_gender", nullable = false)
    private GenderTypeEntity teacherGender;
    ...
    public GenderTypeEntity getTeacherGender() {
        return teacherGender;
    }

    public void setTeacherGender(GenderTypeEntity teacherGender) {
