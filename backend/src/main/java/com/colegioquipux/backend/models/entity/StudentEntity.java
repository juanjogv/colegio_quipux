...
public class StudentEntity {
    ...
    @JoinColumn(name = "student_gender", nullable = false)
    private GenderTypeEntity studentGender;
    ...
    public GenderTypeEntity getStudentGender() {
        return studentGender;
    }

    public void setStudentGender(GenderTypeEntity studentGender) {
